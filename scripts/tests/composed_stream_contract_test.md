...
row_id=$(../../.build/kwil-cli database call key:compose_visibility only_latest:true --action=get_metadata -n=composed_stream_a --output json | jq -r '.result[0].row_id | @sh')
